...
Обнаржена попытка похищения душа! Введите СЛУЖЕБНУЮ КОМАНДУ, печатающую ДУШУ для ОЧИСТКИ её ресурса.""",
